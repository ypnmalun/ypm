...
wd = "\033[90;1m" # Green
GL = "\033[96;1m" # Green aqua
BB = "\033[34;1m" # Green light
YY = "\033[33;1m" # Green light
GG = "\033[32;1m" # Green light
WW = "\033[0;1m"  # Green light
RR = "\033[31;1m" # Green light
CC = "\033[36;1m" # Green light
B = "\033[34m"    # Green
Y = "\033[33;1m"    # Green
G = "\033[32m"    # Green
W = "\033[0;1m"     # Green
...
def banner():
    ...
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   Fb .......Bruteforce... Tool  ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            CREATED BY: YELL ..PHONE.. NAING |"
    print GL+"  |   DON'T USE THIS TOOL TO HARM SOMEONE       |"
    print WW+"  |            FACEBOOK: -Yell.. Phone.. Naing  |"
    print Y+"  |             INSTAGRAM: YELL. PHONE .NAING   |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ Y.P.N ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         https://www.ypnwhitehacker.blogspot.com "
        ...
        -o:  -.......        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
             ...
             Powered by:\033[97m Yell Phone Naing
      """
